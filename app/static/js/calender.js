...
var dd = new Date();
//this functon automatically executes when page loads
function renderDate() {                 
    // this step shows the current date, month and year in the navbar
    var today = dd.getDate();
    var month = ['January', 'Febuary', 'March', 'April', 'May', 'June', 'July', 'August', 'Sepetember', 'October', 'November', 'December']
    var mm = dd.getMonth();
    ...
    document.getElementById('todays_date').innerHTML = word_month  + ' ' + yy;
