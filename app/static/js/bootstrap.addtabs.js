...
(function ($) {
    ...
    var settings = {
         ...
         */
        local: {
            'refreshLabel': 'Refresh this tag',
            'closeThisLabel': 'Close this tag',
            'closeOtherLabel': 'Close other tags',
            'closeLeftLabel': 'Close left tags',
            'closeRightLabel': 'Close right tags',
            'loadbar': 'Content is loading．．．'
        },
        /**
         * 关闭tab回调函数
    ...
    $.addtabs.close = function (opts) {
        //activate previous TAB if the tab is closed
